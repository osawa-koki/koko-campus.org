...
include_head("ネットワーク基礎");
?>

<!--
ネットワーク社会，ICT（Information and Communication Technology：情報通
信技術）
インターネットサービスプロバイダ（ISP），従量制，月額固定料金，IDF
（Intermediate Distribution Frame），MDF（Main Distribution Frame），パケ
ット交換網，回線交換網，センサネットワーク
同軸ケーブル，より対線，光ファイバケーブル
パケット，VoIP（Voice over Internet Protocol），SIP
-->

<div id = "main">
	<p id = "my_comment">セキュリティ面の学習、お疲れさまでした。<br><br>今回からは、ネットワークの勉強に入ります。<br>最初はネットワークの基礎(無線LAN等)の仕組みついて学びましょう♪<br><br>それでは、Let's dance!!</p>
	<h2>無線LAN</h2>
	<p>いわゆる「Wi-Fi」ですね、、、<br>IEEE 802.11シリーズで標準化されています。<br><br>媒体アクセス制御方式として「<span class = "underline">CSMA/CA</span>」方式を採用しています。<br><br>以下にIEEE 802.11シリーズの特徴をまとめました。</p>
	<div class = "scroll_x">
		<table border = "1" id = "wifi">
	...
	<p class = "explanation"><span class = "underline">bps</span>とは、、、<br><br>「bit per second」の略で、通信速度の指標として用いられます。</p>
	<div class = "exam">
		&#9836;&#9836;&#9836; 平成31年春試験午前&#8545;問18 &#9836;&#9836;&#9836;
		<div class = "separator"></div>
	...
	<h2>SSID</h2>
	<p>「Service Set ID」の略で、ネットワーク(無線LAN)におけるアクセスポイントの識別子のことです。<br>SSIDには、「ESSID」と「BSSID」の2種類あります。</p>
	<div class = "scroll_x">
		<table border = "1">
	...
	<p>また、無線LANのモードには「インフラストラクチャモード」と「アドホックモード」の2つに分類されます。</p>
	<div class = "scroll_x">
		<table border = "1">
	...
	<p>無線LANのセキュリティについては<a href = "sc-1-2-8?to=href_l2-security">こちら</a>。</p>
	<h2>トラフィック理論</h2>
	<p>ネットワーク上でどのようにデータを送受信するのが効率的かどうかについての理論です。<br><br>僕が受験した際には全く知らなかった知識です。<br>初めて勉強したときは「ほぅ」と思いました。<br><br>トラフィック理論で用いられる用語等を説明しますね♪</p>
	<div class = "scroll_x">
		<table border = "1">
			...
			<tbody>
				...
				<tr>
					<th>アーランB式</th>
					<td>呼損率を求めるための式です。<br>以下の式から導き出されます。<br><small>※MathMLを使用しているため、「safari・mozilla」等以外では適切に表示されません。<br>(2021年9月18日時点)</small><br>
