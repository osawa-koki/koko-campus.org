...
<body>
	...
	if ($check === 1 || $check === 2 || $check === 4) {
		...
		<div class = "login_as">
			...
			<p>・会員登録は<a href = "../../../member/register">こちら</a>。</p>
			<p>・ログインは<a href = "../../../member/login">こちら</a>。</p>
		</div>
...
function include_footer() {
	...
	<footer>
		...
		<div class = "get_it_center">
			<!--<a id = "button_to_test" href = "<?php //echo $from_where; ?>-test" target = "_blank">確認テストに挑戦♪♪♪</a>-->
		</div>



		<p id = "finish">お疲れ様でした♪<br>理解度はいかがでしょうか?<br><br>質問等あれば遠慮なく聞いてくださいね♪<br>問い合わせフォームは<a href = "https://koko-campus.org/contact/index">こちら</a>。</p>


		<div id = "button_container">

			<div class = "get_it_center">
				<a id = "button_back">前へ</a>
			</div>

			<div class = "button_mid_container">
				<div class = "get_it_center">
					<a id = "button_to_top" href = "./top">トップへ</a>
				</div>
				<?php
				if ($_SESSION["ok"] == 1) {
