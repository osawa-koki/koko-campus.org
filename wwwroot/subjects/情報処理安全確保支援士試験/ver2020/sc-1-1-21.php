...
include_head("情報セキュリティ対策");
?>

<div id = "main">
	<p id = "my_comment">今回はとても少ないです。<br><br>セキュリティ対策について学びます。<br><br>それでは、Let's explorer!!</p>
	<h2>情報セキュリティ対策</h2>
	<p>情報セキュリティ対策は大きく以下の3つに分けられます。</p>
	<ul>
		<li>人的セキュリティ</li>
		<li>技術的セキュリティ</li>
		<li>物理的セキュリティ</li>
	</ul>
	<p>次に、それぞれの具体的な対策方法を紹介します。<br><small>※シラバスから紹介</small></p>
	<div class = "scroll_x">
		<table border = "1" id = "is_step">
			<tbody>
				<tr>
					<th>人的<br class = "w" />セキュリティ</th>
					<td>
						<ul>
							<li>内部不正防止ガイドライン</li>
							<li>情報セキュリティ啓発</li>
				...
				<tr>
					...
					<td>
						<ul>
							...
							<li class = "is_li">入口・出口対策</li>
							<li class = "is_li">多層防御</li>
							<li>暗号処理</li>
							<li class = "is_li">秘密分散</li>
							<li class = "is_li">秘匿化</li>
							<li>アクセス制御</li>
							<li>脆弱性管理</li>
							<li>ネットワーク監視</li>
							...
							<li>侵入検知</li>
							<li>侵入防止</li>
							<li class = "is_li">検疫ネットワーク</li>
							<li class = "is_li">メール無害化</li>
							<li>メール誤送信対策</li>
							<li class = "is_li">URLフィルタリング</li>
							<li class = "is_li">コンテンツフィルタリング</li>
							<li class = "is_li">TPM</li>
							<li class = "is_li">SED</li>
							<li class = "is_li">TNC</li>
							<li class = "is_li">WORM</li>
							<li class = "is_li">セキュアブート</li>
							<li class = "is_li">電子透かし</li>
							<li class = "is_li">ディジタルフォレンジックス</li>
							<li class = "is_li">DLP</li>
							<li class = "is_li">SIEM</li>
							<li class = "is_li">EDR</li>
							<li>WAF</li>
							<li class = "is_li">RASP</li>
							<li>IDP</li>
							<li>IPS</li>
							<li class = "is_li">UTM</li>
							<li class = "is_li">MDM</li>
							<li class = "is_li">CASB</li>
						</ul>
					</td>
				</tr>
				<tr>
					<th>物理的<br class = "w" />セキュリティ</th>
					<td>
						<ul>
							<li class = "is_li">RASIS</li>
							<li class = "is_li">RAS技術</li>
							<li>耐震耐火設備</li>
							<li class = "is_li">UPS</li>
							<li class = "is_li">多重化技術</li>
							<li class = "is_li">ストレージのミラーリング</li>
							<li>監視カメラ</li>
							<li class = "is_li">セキュリティゲート</li>
							<li class = "is_li">アンチパスバック</li>
							<li>インタロック</li>
							<li class = "is_li">クリアデスク・クリアスクリーン</li>
							<li class = "is_li">USBキー</li>
							<li class = "is_li">セキュリティケーブル</li>
						</ul>
					</td>
				</tr>
			</tbody>
	...
	<div id = "is_step_show">
		...
		<div>
			...
			<small>※参考サイトは<a href = "https://cybersecurity-jp.com/column/53826">こちら</a>。</small>
		</div>
		<div>
			個人情報を単純にマスキングするのではなく、個人情報属性を維持したまま意味のあるデータに書き換えることを言います。
		</div>
		<div>
			最初に検疫とは、、、「伝染病がひろがるのを防ぐため、ある地域に出入りする人や物を検査し、必要な処置をとること。」<br>
			<small>※<a href = "https://languages.oup.com/google-dictionary-ja/">Oxford Languages</a>より。<br><br></small>
			検疫ネットワークとは、このネットワークバージョンで、安全かどうか分からないIT機器を安全と判明するまで、社内ネットワークから隔離する方法です。
		</div>
		<div>
			受信したメールに添付されたマルウェアなどに対して、被害を最小限に抑えるために安全な状態に処理を行うことを言います。<br><br>
			具体的には以下の方法があります。
			<ul>
				<li>添付ファイルの削除</li>
			...
			※CDRとは、、、「Content Disarm and Reconstruction」の略で、「内容の無害化・再構築」と訳されます。<br>ファイルの中身を分解した後に、スクリプト・リンクなどを取り除いた後にもとの形式に戻してファイルを無害化する方法です。<br><br>
			<small>※参考サイトは<a href = "https://www.soliton.co.jp/column/filezens/network-isolation/email-sanitization.html">こちら</a>。</small>
		</div>
		<div>
		...
		<div>
			「Self Encrypting Drives」の略で、自身を暗号化する機能を持つハードディスクドライブ(HDD)のことを言います。<br><br>※参考サイトは<a href = "https://it-trend.jp/encryption/article/64-0090">こちら</a>。
		</div>
		<div>
		...
		<div>
			...
			<p class = "explanation">
				<span class = "underline">BIOS</span>とは、、、<br><br>
		...
		<div>
			...
			<p class = "explanation">
				<span class = "underline">ステガノグラフィー</span>とは、、、<br><br>
		...
		<div>
			...
			<p class = "explanation">
				<span class = "underline">エンドポイント</span>とは、、、<br><br>
		...
		<div>
			...
			「SaaS」の利用が進むとことで、<a href = "sc-1-1-2?to=href_shadow">シャドーIT</a>(企業が管理できていないIT機器)も当然に増えていきます。<br><br>これを適切に管理することをサポートする技術がCASBです。<br><small>※僕もこのページを作成するまで知らない単語でした。かなりトレンドになっているらしいです。僕ももっと勉強してみますね♪</small><br><br>以下の4つの機能を持ちます。
			<ul>
				<li>可視化・分析</li>
				<li>コントロール</li>
				<li>データ保護</li>
	...
	<h2>物理的攻撃手法</h2>
	<p>上で物理的セキュリティに関して説明しましたが、代表的な物理的攻撃手法を2つ紹介しますね♪</p>
	<div class = "explanation">
		<span class = "underline">ソーシャルエンジニアリング</span><br><br>
	...
	<p class = "explanation">
		<span class = "underline">TEMPEST攻撃</span>
