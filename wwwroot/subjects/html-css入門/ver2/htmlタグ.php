...
<h4>絶対パス指定</h4>
サイトのロゴなどの絶対に保存場所が変わらない場合に使用します。<br />全部絶対パスではディレクトリを移動させた際に指定が崩れてしまうという問題や、コードを書く量が増えてしまうという問題があります。<br />このページでは、左上に表示されているkoko-campusのロゴに対して使用しています。<br /><br />「src="koko-campus.org/pics/logo.png"」って感じで使用します。
<h4>相対パス指定</h4>
...
<div class="result">
	トップページは<a class="x" href="https://koko-campus.org">こちら</a>。
</div>
...
<a href="../../php入門/branch" class="link to-php入門">php入門</a>
...
<table>
	...
	<tbody>
		...
		<tr>
			<th>action</th>
			<td>submit(送信)ボタンを押した際に遷移するページを指定します。<br />ここでは「next.php」とします。</td>
		</tr>
	</tbody>
</table>
<h3>input</h3>
...
<table>
	...
	<tbody>
		<tr>
			<th>name</th>
			<td>遷移先のページでユーザが入力したデータを取り出すための識別子です。<br />phpなどのサーバ側のプログラムで使用します。</td>
		</tr>
	</tbody>
</table>
