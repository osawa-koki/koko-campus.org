...
<table class="exp">
	...
	<tbody>
		...
		<tr>
			<td>「かつ」を意味します。<br />両方とも「真」の場合にのみ「真」となり、それ以外は「偽」となります。</td>
			<td>「または」を意味します。<br />どちらか一方、ないしは両方が「真」の場合に「真」となり、両方とも「偽」の場合に「偽」となります。</td>
		</tr>
	</tbody>
</table>
<br />
また論理値を逆転させるための論理演算子である否定は「!」で表します。<br />「真」の場合は「偽」となり、「偽」の場合は「真」となります。
<h2>オペランド・式・文</h2>
