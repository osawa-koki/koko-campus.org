...
function head($obj) {
	...
	$subjectsConverter = json_decode(file_get_contents(__DIR__. "/../../subjectsName-converter.json"), true);
	$subjectsname_toLink = $title;
	$subjectsname_toShow = (isset($subjectsConverter[$title])) ? $subjectsConverter[$title] : $title;
	?>
	<!DOCTYPE html>
	<html lang="ja">
	<head>
		...
		<title><?php echo $subjectsname_toShow; ?></title>
		<link rel="stylesheet" href="../../framework/ver3/style.css">
		<link rel="stylesheet" href="../../framework/ver3/link.css">
	...
	<body>
		<header>
			...
			<h1>
				<?php
				$subjectsConverter = json_decode(file_get_contents(__DIR__. "/../../subjectsName-converter.json"), true);
				if (isset($subjectsConverter[$title])) {
					echo $subjectsConverter[$title];
				} else {
					echo $title;
				}
				?>
		...
		<nav>
			<ol>
				...
				<li><a href="../index"><?php echo $subjectsname_toShow; ?></a></li>
				<li><?php echo $file; ?></li>
			</ol>
			<br />
			<ul>
...
function footer() {
		...
		<script charset = "UTF-8" type="text/javascript" src = "../../framework/ver3/entire.js" defer></script>
