...
また、「a」タグの「href」属性に「#id名」と設定するとページ内リンクを生成できます。<br />例えば「&lt;a href="#target"&gt;クリック&lt;/a&gt;」とするとidがtargetである要素まで自動でスクロールされます。<br />ページ内リンクと呼びます。
<p class="r">id名を省略して「href="#"」とした場合はページの一番上に飛びます。</p>
<h2>クラス</h2>
