...
?>
<h2>html</h2>
htmlについては簡単な書き方を理解していますか???<br />ここはphpがテーマですのでhtmlに関する深い知識は必要ありませんが、webサイトを構築するにあたってhtmlの知識は必要不可欠です。<br />htmlの学習が終わっていない方はhtmlを最初に学習してください。
<a class="link to-html-css入門" href="../../html-css入門/branch">html&amp;css入門</a>
...
これ以降のhtmlコードは「!!ここにhtmlの本体を書いていきます!!」の部分のみ記述します。<br /><br />このhtmlは必要最低限な情報です。<br />あくまでもフォームを作成することを目的としているので、、、
<h2>フォーム</h2>
...
<div class="scroll-600w">
	<table>
		...
		<tbody>
			<tr>
				<th>method</th>
				<td>http通信の方法を指定します。<br />主に「GET」と「POST」の2種類を使用します。<br />簡単なデータならば「GET」・大量または重要なデータならば「POST」を使用してください。<br />ここでは原則として「POST」を用います。</td>
			</tr>
			<tr>
				<th>action</th>
				<td>
...
実際にどんなことをするかを実演してみますね♪<br />以下のフォームを実際に入力して送信ボタンを押してください。
<p class="r">普通に次へ進むボタンを押してもokです。</p>
<div id="real-form" class="goal2">
	<form action="php基礎(1)" method="post">
		<div class="goal-title">
			自己紹介記入カード
		</div>
		名前
